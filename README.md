...
3.  **Global Contribution:** Compare country-wise contributions to Netflix’s catalog.
...
| `type` | [cite_start]Whether the content is a **Movie** or **TV Show**[cite: 4]. |
| `title` | Title of the content. |
| `director` | Director(s) of the content. |
| `cast` | Main actors/actresses. |
| `country` | Country/countries of production/origin. |
| `date_added` | Date the content was added to Netflix. |
| `release_year` | [cite_start]Original release year of the content[cite: 5]. |
